...
class MAML:
	...
	def construct_model(self, inputa, inputb, modela, modelb, prefix='maml'):
	...
	def construct_conv_weights(self):
		...
		dtype = tf.float32
		conv_initializer =  tf2.keras.initializers.GlorotNormal()
		fc_initializer = tf2.keras.initializers.GlorotNormal()
		k = 3
